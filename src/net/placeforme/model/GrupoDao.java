...
public class GrupoDao {
	...
	public List<Grupo> getAll() {
		...
		database = dbHelper.getReadableDatabase();
		Cursor cursor = database.query(DbHelper.TABLE_GRUPO, ALLCOLUMNS, null,
				null, null, null, null);
	...
	public int update(Grupo grupo) {
		...
		values.put(DbHelper.TABLE_GRUPO_TITULO, grupo.getTitulo());
		values.put(DbHelper.TABLE_GRUPO_STATUS, grupo.getStatus());
		int ret = database.update(DbHelper.TABLE_GRUPO, values,
				DbHelper.TABLE_GRUPO_ID + " = ?",
	...
	public int count() {
		String countQuery = "SELECT " + DbHelper.TABLE_GRUPO_ID + " FROM "
