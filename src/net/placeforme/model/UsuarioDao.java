...
public class UsuarioDao {
	...
	private String[] ALLCOLUMNS = new String[] { DbHelper.TABLE_USUARIO_ID,
			DbHelper.TABLE_USUARIO_NOME, DbHelper.TABLE_USUARIO_FOTO,
			DbHelper.TABLE_USUARIO_EMAIL, DbHelper.TABLE_USUARIO_SENHA,
			DbHelper.TABLE_USUARIO_TIPO, DbHelper.TABLE_USUARIO_STATUS };
	...
	public long add(Usuario usuario) {
		...
		values.put(DbHelper.TABLE_USUARIO_FOTO,
				Utils.BitMapToString(usuario.getFoto()));
	...
	public Usuario get(long id) {
		...
		Cursor cursor = database.rawQuery("SELECT * FROM "
				+ DbHelper.TABLE_USUARIO + " WHERE "
				+ DbHelper.TABLE_USUARIO_ID + " = " + id, null);
	...
	public int update(Usuario usuario) {
		...
		values.put(DbHelper.TABLE_USUARIO_TIPO, usuario.getTipo());
		values.put(DbHelper.TABLE_USUARIO_STATUS, usuario.getStatus());
		int ret = database.update(DbHelper.TABLE_USUARIO, values,
	...
	public int count() {
		String countQuery = "SELECT " + DbHelper.TABLE_USUARIO_ID + " FROM "
	...
	public Usuario login(String email, String senha) {
		...
		database = dbHelper.getReadableDatabase();
		Cursor cursor = database.query(DbHelper.TABLE_USUARIO, ALLCOLUMNS,
				DbHelper.TABLE_USUARIO_EMAIL + " =? AND "
						+ DbHelper.TABLE_USUARIO_SENHA + " =? ", new String[] {
						email, senha }, null, null, null, null);
