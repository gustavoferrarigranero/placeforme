...
public class TabTwoActivity extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_tab_two, container,
				false);

		buttonRemFiltrosStatic = (Button) view
				.findViewById(R.id.button_remove_filtros);
		...
		add_evento.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				criarEvento = new Intent(MainActivity.mainActivity,
						AddEventoActivity.class);
	...
	private void populaLista() {
		...
		eventos = eventoDao.getAllNews();

		AdapterListEventos adapter = new AdapterListEventos(
	...
	public static void populaListaStaticFiltros(String titulo, String data,
		...
		eventos = eventoDao.getAllNewsFiltros(titulo, data, grupo_id);
